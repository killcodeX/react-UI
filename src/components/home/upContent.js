        ...
        <div className="card">
          <div className="card-body card-content-up">
            <div className="left-side-contents">
              ...
              <img
                className="pr-4 pt-2 product-img"
            ...
            <div className="right-side-contents">
              ...
              <div className="right-side-contents-down">
                <div className="contents-up">
                  <img
                    className="aprroved-img"
                    src="assests/images/logo-approved.png"
                    alt="logo-approved"
                  />
                  <p className="pl-4 para">
                    205/55 R16 H<br />
                    SUV
                  </p>
                  <div className="stock para">
                    ...
                    <p className="pt-1">
                      Price <strong>$ 340</strong>
                    </p>
                  </div>
                  <p className="pl-4 para">
                    {" "}
                    Total <strong>$ 1360</strong>
                  </p>
                </div>
                <div className="contents-down">
                  <div className="valueButton">
                    ...
                    <Button className="cal-btn" onClick={() => add>1 ? setAdd(add - 1) : null}>
                      -
                    </Button>
                  </div>
                  <div className="cart">
